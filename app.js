...
function renderTasks() {
    ...
    tasks.forEach((task, index) => {
        ...
        // Determine section (Today / Upcoming / Overdue)
        const now = new Date();
        ...
        if (task.deadline) {
            if (taskDate.toDateString() === now.toDateString()) section = document.getElementById("today");
            else if (taskDate < now && !task.completed) section = document.getElementById("overdue");
        }
